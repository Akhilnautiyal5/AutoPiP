...
chrome.storage.sync.get(["hotkeys"], function (result) {
	...
	document.getElementById("toggleHotkey").value = hotkeys.toggle;
	document.getElementById("playPauseHotkey").value = hotkeys.playPause;
	document.getElementById("rewindHotkey").value = hotkeys.rewind;
	document.getElementById("forwardHotkey").value = hotkeys.forward;
});

// Save hotkey settings
document.getElementById("saveHotkeys").addEventListener("click", function () {
	const hotkeys = {
		toggle: document.getElementById("toggleHotkey").value,
		playPause: document.getElementById("playPauseHotkey").value,
		rewind: document.getElementById("rewindHotkey").value,
		forward: document.getElementById("forwardHotkey").value,
	};
